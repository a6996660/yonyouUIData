...
public interface DbRelationService {
     ...
     * @return 树形结构数据
     */
    DbTreeResponse getDbRelationTree(String environment, String dbName, String billNo, DbConfigDTO dbConfig);
     ...
     * @return 表详情数据
     */
    TableDetailsResponse getTableDetails(String environment, String dbName, String tableName, String id, DbConfigDTO dbConfig);
} 